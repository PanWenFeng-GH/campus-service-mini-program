...
Page({
  ...
  getList(){
    ...
    config.api.post(config.host + "/api/partTime/listMy",{page:this.data.page,limit:this.data.limit}).then((res) => {
    ...
    wx.showModal({
      ...
      success(res) {
        if (res.confirm) {
          ...
          config.api.post(config.host + "/api/partTime/dell",postComment).then((res) => {
